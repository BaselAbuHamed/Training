...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="container-edit">
            <h1>Edit Question</h1>
            <form action="../Controllers/cont_update_question.php"
                id="updateQuestionForm" method="post" onsubmit="updateForm()">
                <input type="hidden" name="questionID"
                    value="<?php echo getQuestionID(); ?>" />
                <label for="question">Question:</label>
                <input type="text" name="question" id="question"
                    value="<?php echo htmlspecialchars(getDetails()['question']); ?>" />
                <span class="error" id="questionError"></span>
                <label for="correctAnswer">Correct Answer:</label>
                <input type="text" name="correctAnswer"
                    id="<?php echo htmlspecialchars(getDetails()['correctAnswer']);?>"
